...
//	@Before(value = "execution(* com.ssafy.back.board.model.mapper.Board*.*(..))")
...
//	}
	...
	//asdadsasdsasadsaasdsadsd
//	@Around(value = "execution(* com.ssafy.back.board.model.mapper.Board*.*(..))")
...
//	@AfterReturning(value = "execution(* com.ssafy.back.board.model.mapper.Board*.list*(..))", returning = "obj")
...
//	}
//
//	@AfterThrowing(value = "execution(* com.ssafy.back.board.model..Board*.list*(..))", throwing = "exception")
//	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
//		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
//		logger.debug("exception : {}", exception);
//	}
//
//	@After(value = "execution(* com.ssafy.back.board.model..Board*.list*(..))")
