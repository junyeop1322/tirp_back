...
//	//http://localhost/vue/swagger-ui/index.html
    ...
    public Docket allApi() {
        return new Docket(DocumentationType.OAS_30)
            ...
            .apiInfo(allApiInfo())
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.ssafy.back"))
    ...
    public Docket userApi() {
        return new Docket(DocumentationType.OAS_30)
            ...
            .apiInfo(userApiInfo())
            .select()
            .apis(RequestHandlerSelectors.basePackage("com.ssafy.back.member.controller"))
...
//            .select()
//            .apis(RequestHandlerSelectors.basePackage("com.ssafy.back.board.controller"))
...
//            .apiInfo(mapApiInfo())
//            .select()
//            .apis(RequestHandlerSelectors.basePackage("com.ssafy.back.map.controller"))
