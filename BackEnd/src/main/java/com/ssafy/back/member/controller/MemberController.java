package com.ssafy.back.member.controller;
...
import com.ssafy.back.member.model.service.MemberService;
import com.ssafy.back.util.JWTUtil;
...
//				로그인 사용자 정보.
	...
	@ApiOperation(value = "Access Token 재발급", notes = "만료된 access token을 재발급받음.", response = Map.class)
	@PostMapping("/refresh")
